...
Objects returned by caret::train tend to be very large. They contain all of the data used to create the model, including each fold or resample, and the fully expanded models that was created in each instance. Since this information takes up valuable space and is not commonly needed, we've included the trim function as a parameter for a less dense list of models.
```{r eval = FALSE}
  if (trim_models == TRUE) {
